...
(function () {
  ...
  var idOfContactBeingEdited = JSON.parse(localStorage.idOfContactBeingEdited);

  contacts.forEach(function (contact) {
    if(idOfContactBeingEdited == contact.id) {
...
function updateContact() {
  ...
  contacts.forEach(function (contact) {
    if(idOfContactBeingEdited == contact.id) { // capitalize name initials (a little sanitation)
  ...
  localStorage.idOfContactBeingEdited = JSON.stringify('updated');
}
